  ...
  return (
    <div className="w-full px-6 z-20 -mt-2">
      <div className="text-center relative">
        ...
        <h1 className="text-white text-5xl font-bold tracking-tight mb-2 font-display drop-shadow-lg">{title}</h1>
        {targetAudience && (
          <p className="text-primary/70 text-xs tracking-[0.2em] font-bold uppercase mb-4 drop-shadow-md">
            ({targetAudience})
          </p>
        )}
